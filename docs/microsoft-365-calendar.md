...
P2-03 retrieves and normalizes events. P2-04 reconciles repeated results without duplicates, and
P2-05 queues unmatched events for an explicit project decision that later runs can reuse.
