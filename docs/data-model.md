...
1. Captured input begins as an action item or inbox task, never as silently accepted work.
...
5. Evening Close reviews all items captured that day and records the disposition of unfinished work.
6. Project health is explicitly confirmed by the user even when the system suggests a value.
